        ...
        >
            <div className="flex items-center justify-center w-full h-full bg-gray-900/60 lg:bg-gray-900/40">
                <div className="text-center">
                    ...
                    <button className="px-3 py-2 mt-3 text-sm lg:text-base font-medium text-white capitalize transition-colors duration-300 transform bg-lime-600 rounded-md lg:px-4 lg:py-2 lg:mt-3 hover:bg-lime-500 focus:outline-none focus:bg-lime-500">
                        Choose Recipe
                    </button>
